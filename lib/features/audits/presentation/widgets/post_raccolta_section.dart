  ...
  Future<void> _saveData() async {
    ...
    try {
      ...
      final companion = PostHarvestRecordsCompanion.insert(
        ...
        mbVerifiedProducts: const drift.Value(''),
        mbInputData: const drift.Value(''),
        mbInputDocs: const drift.Value(''),
        mbOutputData: const drift.Value(''),
        mbOutputDocs: const drift.Value(''),
        mbComment: const drift.Value(''),
