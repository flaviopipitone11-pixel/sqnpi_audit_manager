...
import '../../audits/application/audit_stats_provider.dart';
import '../../audits/application/weather_provider.dart';
...
class SqnpiHomePage extends ConsumerStatefulWidget {
  const SqnpiHomePage({super.key});

  @override
  ConsumerState<SqnpiHomePage> createState() => _SqnpiHomePageState();
}

typedef HomePage = SqnpiHomePage;

class _SqnpiHomePageState extends ConsumerState<SqnpiHomePage> {
