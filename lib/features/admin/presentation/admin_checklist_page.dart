            ...
            child: Column(
              ...
              children: [
                _buildField(
                  ...
                  label: 'Descrizione Obbligo',
                  maxLines: 5,
                ),
                const SizedBox(height: 16),
                _buildField(
                  controller: noteNormaController,
                  label: 'Note Norma',
                  maxLines: 3,
                ),
                const SizedBox(height: 16),
                  ...
                  children: [
                    Expanded(
                      child: _buildField(
                        ...
                        label: 'Tipo Indicatore (CI/CD)',
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: _buildField(
                        controller: derogheController,
                        label: 'Deroghe',
                      ),
                    ),
                  ],
            ...
            onPressed: () async {
              final confirm = await showDialog<bool>(
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: const Text(
                    'Questo ripristinerà tutti i testi originali dall\'Excel ufficiale. Le modifiche manuali andranno perse. Continuare?',
                  ),
                  actions: [
                    TextButton(
              ...
              if (confirm == true) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Checklist ripristinata con successo.'),
                  ),
                );
              }
            },
          ...
          Expanded(
            child: StreamBuilder<List<ChecklistItem>>(
              ...
              builder: (context, snapshot) {
                  ...
                  list = list
                      .where(
                        (e) =>
                            ...
                            e.obbligo.toLowerCase().contains(q),
                      )
                      .toList();
                }
                ...
                if (list.isEmpty) {
                  return const Center(child: Text('Nessun requisito trovato.'));
                }
